 ...
 */
public class Snippet12_RecordPointPanelSimulation extends
		com.eco.bio7.compile.Model {
	...
	public void points() {
		...
		// PointPanel.createVoronoi();if you want to record Voronoi! Disable
		// dynamic in the Image-Methods view for performance if necessary!
