 ...
 */
public class Koch extends com.eco.bio7.compile.Model {
	...
	void branch(float h) {
		...
		if (h > 2) {
			embed.pushMatrix(); // Save the current state of transformation
			...
			embed.popMatrix(); // Whenever we get back here, we "pop" in order
