...
#for (i in 1:runs) {
#  a <- new("geMatrix", x = rnorm(600*600), Dim = as.integer(c(600,600)))
#  b <- as.double(1:600)
#  invisible(gc())
#  timing <- system.time({
...
#cumulate <- 0; b <- 0
#for (i in 1:runs) {
#  a <- crossprod(new("geMatrix", x = rnorm(900*900),
...
#cumulate <- 0; b <- 0
#for (i in 1:runs) {
#  a <- new("geMatrix", x = rnorm(400*400), Dim = as.integer(c(400, 400)))
#  invisible(gc())
