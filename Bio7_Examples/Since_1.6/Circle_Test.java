...
/*
An ImageJ Plugin class can now be compiled (tested) dynamically with the "Compile Java Dynamically" 
action in the context menu of the Navigator view (select the 
