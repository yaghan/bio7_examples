...
/*
To run this example select "Compile and Run" from the 
context menu of the Navigator !
An instance is created in the ecomain method which is called in Compile and Run.
The Path to the text data is "FileRoot.getFileRoot()"+project etc.

Website for this library and more examples:

http://www.jooneworld.com/
http://www.jooneworld.com/wiki/tiki-index.php
*/


static String path = FileRoot.getFileRoot()+"/Ecological Modelling/Neural Network/Joone/";
