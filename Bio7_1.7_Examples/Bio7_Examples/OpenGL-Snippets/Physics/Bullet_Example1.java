...
public void ecomain(GL2 gl, GLU glu, GLUT glut) {
	...
	if (dynamicsWorld != null) {
		...
		SpatialCamera.setCustomCamera(vec.x,vec.y,vec.z + 50,vec.x,vec.y,vec.z);
...
public void initPhysics() {
		...
		// We can also use DemoApplication::localCreateRigidBody, but for clarity it is provided here:
		{
            ...
            RigidBodyConstructionInfo rbInfo2 = new RigidBodyConstructionInfo(mass, myMotionState, groundShape2, localInertia);
